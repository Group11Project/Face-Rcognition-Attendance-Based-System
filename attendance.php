...
<div id="page-wrapper">
            <div class="container-fluid">
                ...
                $sql ="SELECT  coursename from course where course_id=$cid";
                    $user_query=mysqli_query($db,$sql) or die("error getting data");
                    while($row = mysqli_fetch_array($user_query, MYSQLI_ASSOC)){
                    ...
                    ?>
                        ...
                        <center><h4><strong> <?php echo $coursename ?> </strong></h4></center>
                       
                        <center><h4><strong> attendence of  <?php echo $sname; ?> <?php echo $sname1; ?> &nbsp;  admission no. : <?php echo $id; ?> </strong><h4></center>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="myTable" >
                                        ...
                                        <thead>
                                          <tr>
                                                ...
                                                <th><center>attendence</center></th>
                    ...
                    while($row = mysqli_fetch_array($user_query, MYSQLI_ASSOC)){
                        ...
                        ?>
                                                ...
                                                <td><center><?php echo $row['AttDate']; ?></center></td>
                                                <td><center><?php if($row[$id]==1){echo "present"; $cnt++;}else{ echo "absent"; $abs++;} ?></center></td>
                                ...
                                <h3> total  days :<?php  echo $cnt+$abs?></h3>
                                <h3> total present days :<?php  echo $cnt?></h3>
                                <h3> total absent days :<?php  echo $abs?></h3>
