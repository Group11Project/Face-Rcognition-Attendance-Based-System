...
<!--end of heading section-->  
    ...
    <div>
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="sms.php">SMS <img src="assets/img/details.png"></a></li>
            ...
            <div class="tab-pane active" role="tabpanel" id="tab-1">
                ...
                <p>
                    ...
                    <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="sms.php">Type contacts <img src="assets/img/new.png"> </a></li>
                                  <li ><a href="sms2.php">Upload CSV file<img src="assets/img/view2.png"></a></li>
                                </ul>
                            <br>
  ...
  <!--******************************* End of Sub menu****************************************-->  
    ...
    <DIV style="float:left;height:220px; width:auto; border:1px green solid">
     <center><h4><i><font color="red" >Note</font></i></h4>
     To enter multiple number, seperate the contacts by comma (,).<br> you may also upload a CSV file containing the contacts.<br> Ensure that you contacts are in the first column.</center>
    </DIV>
        ...
        <div class="col-sm-6">
            <div>
                <form action="sendsms.php" method="post">
                    ...
                    <input type="text" name="mno" class="form-control" value="<?php  echo $id2 ;?>">
                    <label>Message</label>
