...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="reports_students.php">Reports </a></li>
                                </ul>
                            <br>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        ...
                        <form action="inventory.php" method="POST" enctype="multipart/form-data">
                                ...
                                <!-- <a href="reports_all/form1_students_reports.php">Forms 1[CHM]</a><br>
                                <a href="reports_all/form2_students_reports.php">Forms 2[CFC]</a><br>
                                <a href="reports_all/form3_students_reports.php">Forms 3[DFC]</a><br> 
                                <a href="reports_all/form4_students_reports.php">Forms 4[DHM]</a> <br>
                                <a href="reports_all/borders_students_reports.php">Borders</a><br>
                                <a href="reports_all/day_students_reports.php">Day School</a><br>
                                <a href="reports_all/alumni_students_reports.php">Alumni</a><br> 
                                                           -->
                        </form>
