...
<!--****************************************************************************-->
                 <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="viewstaff.php">View List<img src="assets/img/view2.png"></a></li>
            ...
            <div class="container-fluid">
                ...
                <nav>
                        ...
                        if(isset($_POST['delete'])){
                            ...
                            for($i=0; $i < $N; $i++)
                            {
                                $result = mysqli_query("DELETE FROM staff where staff_id='$id[$i]'");
                            }
                            }
                            ?>
                        <!-- block -->                      
                        <div id="block_bg" class="block">   
                            ...
                            <table>
                            <tr>
                            <td><a button type='button' class="btn btn-primary" href="staff.php"><--</a></td>
                            <td><a button type='button'  href="#" class="btn btn-primary glyphicon  glyphicon-print"></a></td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="myTable">
                                        ...
                                        <thead>
                                          <tr>
                                                ...
                                                <th><center>Roles/Designation</center></th>
                    ...
                    $id = $row['staff_id'];
                        ...
                        ?>
                                                ...
                                                <td><center><?php echo $row['roles']; ?></center></td>
                                            
                                                <td>
                                                <center><a href="edit_staff.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i>Edit</a></center></td>
