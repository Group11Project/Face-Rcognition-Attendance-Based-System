...
<!--****************************************************************************-->
                        ...
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                 ...
                                 <li class="active"><a href="deletecourse.PHP">Delete <img src="assets/img/delete2.png"></a></li>
...
<h4><center><h4><strong>Select Course to delete</strong></h4></center></h4>
                        ...
                        <form method="POST" action="deletecourse.php">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td colspan="2"><input type="submit" name="register" value="Delete" class="btn btn-primary" ></td>
                                            </tr>
                                            </tr>
                                    </table>
                                </form>
...
mysqli_query($db,"DELETE FROM course WHERE course_id ='$courseID'") or die(mysqli_error($db));
