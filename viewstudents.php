...
<div id="page-wrapper">
            <div class="container-fluid">
                ...
                <?php
                    ...
                    ?>
                <center><h4><strong>Students list, Course:&nbsp;<?php echo $coursename; ?></strong><h4></center>
                        ...
                        if(isset($_POST['delete'])){
                            ...
                            for($i=0; $i < $N; $i++)
                            {
                                $result = mysql_query("DELETE FROM studentstable where admission_number='$id[$i]'");
                            }
                            }
                            ?>
                        <!-- block -->                      
                    ...
                    $id = $row['admission_number'];
                        ...
                        ?>
                                                ...
                                                <td>
                                                <center><a href="attendance.php <?php echo '?id='.$id;?>" class="btn btn-success"><i class="glyphicon "></i>attendence</a></center></td>
