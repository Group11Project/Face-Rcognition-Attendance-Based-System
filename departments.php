                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                          ...
                          <h4>Department Details</h4>
                            ...
                            Head of Department <select name="hod" class="form-control" >  
                                                  <?php
  ...
  <?php
   include('connect.php');
    if (isset($_POST['register'])){
     ...
     mysqli_query($db,"INSERT INTO departments(departmentname, hod) VALUES ('$departmentname','$hod')") or die(mysqli_error($db));
