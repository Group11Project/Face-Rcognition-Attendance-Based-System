       ...
       <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    ...
                    <form action="update.php" method="POST" enctype="multipart/form-data">                         
                        ...
                        <label>DOB</label>
                        <input type="text" name="dateofbirth" placeholder="dd-mm-yyyy" value="<?php echo $dateofbirth?>" class="form-control">
                        
                        <label>Gender</label>
                        <select id="gender" name="gender" value="<?php echo $gender?>" class="form-control">  
                                            <option></option>
                                                <?php 
                                                    $query=mysqli_query($db,"select * from genderset");
                        ...
                        <input type="text" name="zipcode" value="<?php echo $zipcode?>" class="form-control"> 
                         ...
                         <input type="text" name="reg_date"  placeholder="dd-mm-yyyy" required value="<?php echo $reg_date; ?>" class="form-control" >
